...
@section('head')
    ...
    <link href="{{ url(asset('assets/plugins/morris-chart/css/morris.css')) }}" rel="stylesheet" type="text/css" media="screen" />
    <link href="{{ url(asset('assets/plugins/jquery-ui/smoothness/jquery-ui.min.css')) }}" rel="stylesheet" type="text/css" media="screen" />
    <link href="{{ url(asset('assets/plugins/rickshaw-chart/css/graph.css')) }}" rel="stylesheet" type="text/css" media="screen" />
    <link href="{{ url(asset('assets/plugins/rickshaw-chart/css/detail.css')) }}" rel="stylesheet" type="text/css" media="screen" />
    <link href="{{ url(asset('assets/plugins/rickshaw-chart/css/legend.css')) }}" rel="stylesheet" type="text/css" media="screen" />
    <link href="{{ url(asset('assets/plugins/rickshaw-chart/css/extensions.css')) }}" rel="stylesheet" type="text/css" media="screen" />
    <link href="{{ url(asset('assets/plugins/rickshaw-chart/css/rickshaw.min.css')) }}" rel="stylesheet" type="text/css" media="screen" />
    <link href="{{ url(asset('assets/plugins/rickshaw-chart/css/lines.css')) }}" rel="stylesheet" type="text/css" media="screen" />
    <link href="{{ url(asset('assets/plugins/jvectormap/jquery-jvectormap-2.0.1.css')) }}" rel="stylesheet" type="text/css" media="screen" />
    <link href="{{ url(asset('assets/plugins/icheck/skins/minimal/white.css')) }}" rel="stylesheet" type="text/css" media="screen" />
...
@section('body')
    ...
    <script src="{{ url(asset('assets/plugins/easypiechart/jquery.easypiechart.min.js')) }}" type="text/javascript"></script>
    ...
    <script src="{{ url(asset('assets/plugins/jvectormap/jquery-jvectormap-2.0.1.min.js')) }}" type="text/javascript"></script>
    <script src="{{ url(asset('assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js')) }}" type="text/javascript"></script>
